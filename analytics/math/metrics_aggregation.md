...
| DEBUGGING_PLAN.md Phase 5 | Bug ledger and fix plan that this file's "affected by" columns trace to |
| LEGACY_BUGS_LOG.md | Per-bug detail (Bug 2, Bug 5, Bug 6, Bug 7, Bug 8) |
