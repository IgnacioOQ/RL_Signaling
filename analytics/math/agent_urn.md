...
This is the lever that the `Initializations_test.ipynb` experiment was designed to study. (See Bug 5 in LEGACY_BUGS_LOG.md for why the experiment as written silently bypassed this lever.)
...
This concern is recorded as an additional note in Error 5a of LEGACY_ERRORS_LOG.md.
