...
3. **State the open problem** as: lift the per-cell convergence to the joint chain. Cite Argiento et al., 2009 reference [1] for the analogous lifting in the cooperative-payoff Lewis-Skyrms case.
